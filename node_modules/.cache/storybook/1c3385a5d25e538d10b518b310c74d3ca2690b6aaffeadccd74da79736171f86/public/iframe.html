    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.stories.tsx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.tsx)$"}];
      ...
      import './vendors-node_modules_storybook_addon-essentials_dist_actions_preview_mjs-node_modules_storybo-8d0340.iframe.bundle.js';
